...
try:
    ...
    def get_lr(it):
        ...
        if it < args.warmup_iters:
            ...
            # decay measured against the last *executed* update
    ...
    # Best-effort cleanup on *all* ranks
    try:
        if dist.is_available() and dist.is_initialized():
            dist.destroy_process_group()
    finally:
        # Optional: ensure the process exits (helps avoid "zombie" ranks on some clusters)
        pass